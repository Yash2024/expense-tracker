...
@Component({
  selector: 'app-sept',
  templateUrl: './sept.component.html',
  styleUrls: ['./sept.component.css']
})
export class SeptComponent implements OnInit {
  ...
  constructor() {
    this.localitem = localStorage.getItem("septexplist");
  ...
  addexpense() {
    ...
    if (expd.amount === 0 || expd.amount === null) {
      ...
      expd.expid = 9000 + this.explist.length;
      expd.btn = true;
